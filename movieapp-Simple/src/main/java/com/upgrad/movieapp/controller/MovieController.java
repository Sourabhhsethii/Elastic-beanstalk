...
public class MovieController {
  ...
  public ResponseEntity bookMovieDetails(@RequestBody MovieBookingDTO movieBookingDTO){
    ...
    UserDTO fromUser = modelMapper.map(movieBookingDTO.getUser(),UserDTO.class);
    TheatreDTO requestedTheatre = modelMapper.map(movieBookingDTO.getTheatre(), TheatreDTO.class);
